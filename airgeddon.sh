#!/usr/bin/env bash
#Title........: airgeddon.sh
#Description..: [TIẾNG VIỆT] Đây là script Bash đa năng cho hệ thống Linux để audit mạng không dây
#               [ENGLISH] This is a multi-use bash script for Linux systems to audit wireless networks.
#Author.......: v1s1t0r
#Version......: 12.01
#Usage........: bash airgeddon.sh
#Bash Version.: 4.2 or later
#Note.........: CHỈ SỬ DỤNG CHO MỤC ĐÍCH HỌC TẬP VÀ NGHIÊN CỨU TRÊN MẠNG CỦA RIÊNG BẠN

#Global shellcheck disabled warnings
#shellcheck disable=SC2154,SC2034

#==============================================
# BIẾN NGÔN NGỮ / LANGUAGE VARIABLES
#==============================================
...
#==============================================
# BIẾN CÔNG CỤ / TOOL VARIABLES
#==============================================

# Công cụ bắt buộc / Essential tools (phải có để airgeddon hoạt động)
essential_tools_names=(
						"iw"              # Quản lý giao diện WiFi
						"awk"             # Xử lý văn bản
						"airmon-ng"       # Bật/tắt chế độ monitor
						"airodump-ng"     # Quét mạng WiFi
						"aircrack-ng"     # Cracking mật khẩu WiFi
						"xterm"           # Terminal giả lập
						"ip"              # Quản lý mạng
						"lspci"           # Liệt kê thiết bị PCI
						"ps"              # Quản lý tiến trình
					)

# Công cụ tùy chọn / Optional tools (tăng cường tính năng)
optional_tools_names=(
						"wpaclean"        # Dọn dẹp file capture
						"crunch"          # Tạo wordlist
						"aireplay-ng"     # Tấn công deauth/inject
						"mdk4"            # Tấn công WiFi nâng cao
						"hashcat"         # Cracking với GPU
						"hostapd"         # Tạo AP giả (Evil Twin)
						"dhcpd"           # DHCP server
						"nft"             # Firewall rules
						"ettercap"        # MITM attack
						"etterlog"        # Xem log ettercap
						"lighttpd"        # Web server cho captive portal
						"dnsmasq"         # DNS/DHCP server
						"wash"            # Quét WPS
						"reaver"          # Tấn công WPS
						"bully"           # Tấn công WPS (alternative)
						"pixiewps"        # Tấn công Pixie Dust
						"bettercap"       # MITM framework
						"beef"            # Browser exploitation
						"packetforge-ng"  # Tạo gói tin
						"hostapd-wpe"     # Enterprise AP
						"asleap"          # Tấn công LEAP
						"john"            # Password cracking
						"openssl"         # SSL/TLS tools
						"hcxpcapngtool"   # Chuyển đổi capture
						"hcxdumptool"     # Bắt gói tin WiFi
						"tshark"          # Packet analyzer
						"tcpdump"         # Packet capture
						"besside-ng"      # Auto WEP/WPA crack
						"hostapd-mana"    # Rogue AP attacks
						"hcxhash2cap"     # Chuyển đổi hash
						"hcxhashtool"     # Xử lý hash
					)
...
#==============================================
# BIẾN CHUNG / GENERAL VARIABLES
#==============================================

# Phiên bản airgeddon / Airgeddon version
airgeddon_version="12.01"

# Phiên bản file ngôn ngữ / Language strings file version
language_strings_expected_version="12.01-1"

# Tên file handshake chuẩn / Standard handshake filename
standardhandshake_filename="handshake-01.cap"

# Tên file PMKID chuẩn / Standard PMKID filename
standardpmkid_filename="pmkid_hash.txt"

# Tên file PMKID capture / Standard PMKID capture filename
standardpmkidcap_filename="pmkid.config"

# Thời gian chờ bắt handshake (giây) / Timeout for handshake capture (seconds)
timeout_capture_handshake_decloak="20"

# Thời gian chờ bắt PMKID (giây) / Timeout for PMKID capture (seconds)
timeout_capture_pmkid="45"

# Thời gian chờ bắt identities (giây) / Timeout for identities capture (seconds)
timeout_capture_identities="45"

# Thời gian chờ phân tích chứng chỉ (giây) / Timeout for certificates analysis (seconds)
timeout_certificates_analysis="45"

# Thời gian chờ downgrade WPA3 (giây) / Timeout for WPA3 downgrade (seconds)
timeout_wpa3_downgrade="25"

# Thời gian chờ phân tích MFP WPA3 (giây) / Timeout for WPA3 MFP analysis (seconds)
timeout_wpa3_mfp_analysis="10"

# Thư mục chứa file hệ thống / System config directory
osversionfile_dir="/etc/"

# Thư mục plugins / Plugins directory
plugins_dir="plugins/"

# File orchestrator / Orchestrator file
ag_orchestrator_file="ag.orchestrator.txt"

# Thư mục tạm / Temporary directory
system_tmpdir="/tmp/"

# Phiên bản Bash tối thiểu / Minimum required Bash version
minimum_bash_version_required="4.2"

# Thông báo resume / Resume message code
resume_message=224

# Câu hỏi hủy / Abort question code
abort_question=12

# Đánh dấu đang dịch / Pending of translation marker
pending_of_translation="[PoT]"

# Escape pattern cho PoT / Escaped pattern for PoT
escaped_pending_of_translation="\[PoT\]"

# Độ phân giải chuẩn / Standard resolution
standard_resolution="1024x768"

# Lỗi 404 của curl / curl 404 error
curl_404_error="404: Not Found"

# Tên file cấu hình / Configuration filename
rc_file_name=".airgeddonrc"

# Tên file cấu hình thay thế / Alternative config filename
alternative_rc_file_name="airgeddonrc"

# Tên file chuỗi ngôn ngữ / Language strings filename
language_strings_file="language_strings.sh"

# MAC broadcast / Broadcast MAC address
broadcast_mac="FF:FF:FF:FF:FF:FF"

# Phiên bản tối thiểu hcxdumptool cho filter AP / Minimum hcxdumptool version for AP filter
minimum_hcxdumptool_filterap_version="6.0.0"

# Phiên bản tối thiểu hcxdumptool cho BPF / Minimum hcxdumptool version for BPF
minimum_hcxdumptool_bpf_version="6.3.0"

# Phiên bản tối thiểu hcxdumptool cho tần số / Minimum hcxdumptool version for frequencies
minimum_hcxdumptool_frequencies_version="7.0.0"

#==============================================
# BIẾN 5GHz VÀ 6GHz / 5GHz AND 6GHz VARIABLES
#==============================================

# Đơn vị GHz / GHz unit
ghz="Ghz"

# Dải tần 2.4GHz / 2.4GHz band
band_24ghz="2.4${ghz}"

# Dải tần 5GHz / 5GHz band
band_5ghz="5${ghz}"

# Dải tần 6GHz / 6GHz band
band_6ghz="6${ghz}"

# Regex kênh hợp lệ 2.4GHz / Valid 2.4GHz channels regex
valid_channels_24_ghz_regexp="([1-9]|1[0-4])"

# Regex kênh hợp lệ 2.4GHz và 5GHz / Valid 2.4GHz and 5GHz channels regex
...
# Regex kênh hợp lệ 6GHz / Valid 6GHz channels regex
...
# Regex tất cả kênh hợp lệ / Valid all channels regex
valid_channels_24_5_and_6_ghz_regexp="(${valid_channels_24_and_5_ghz_regexp}|${valid_channels_6_ghz_regexp})"

# Phiên bản tối thiểu wash dualscan / Minimum wash dualscan version
minimum_wash_dualscan_version="1.6.5"

#==============================================
# BIẾN AIRCRACK / AIRCRACK VARIABLES
#==============================================

# Tên file tạm aircrack / Aircrack temporary filename
aircrack_tmp_simple_name_file="aircrack"

# File POT tạm của aircrack / Aircrack POT temporary file
aircrack_pot_tmp="${aircrack_tmp_simple_name_file}.pot"

# Phiên bản PMKID của aircrack / Aircrack PMKID version
aircrack_pmkid_version="1.4"

#==============================================
# BIẾN HASHCAT / HASHCAT VARIABLES
#==============================================

# Phiên bản hashcat 3.x / Hashcat 3.x version
hashcat3_version="3.0"

# Phiên bản hashcat 4.x / Hashcat 4.x version
hashcat4_version="4.0.0"

# Phiên bản hashcat hỗ trợ hccapx / Hashcat version supporting hccapx
hashcat_hccapx_version="3.40"

# Phiên bản hashcat chuyển đổi hcx / Hashcat version for hcx conversion
hashcat_hcx_conversion_version="6.2.0"

# Phiên bản tối thiểu hashcat cho PMKID / Minimum hashcat version for PMKID
minimum_hashcat_pmkid_version="6.0.0"

# Phiên bản hashcat deprecated 2500 / Deprecated hashcat 2500 version
hashcat_2500_deprecated_version="6.2.4"

# Plugin hashcat cho handshake / Hashcat plugin for handshake
hashcat_handshake_cracking_plugin="2500"

# Plugin hashcat cho PMKID / Hashcat plugin for PMKID
hashcat_pmkid_cracking_plugin="22000"

# Plugin hashcat cho enterprise / Hashcat plugin for enterprise
hashcat_enterprise_cracking_plugin="5500"

# Tên file tạm hashcat / Hashcat temporary filename
hashcat_tmp_simple_name_file="hctmp"

# File tạm hashcat / Hashcat temporary file
hashcat_tmp_file="${hashcat_tmp_simple_name_file}.hccap"

# File POT tạm hashcat / Hashcat POT temporary file
hashcat_pot_tmp="${hashcat_tmp_simple_name_file}.pot"

# File output hashcat / Hashcat output file
hashcat_output_file="${hashcat_tmp_simple_name_file}.out"

# Công cụ chuyển đổi hccapx / hccapx converter tool
hccapx_tool="cap2hccapx"

# Các vị trí có thể tìm hccapx converter / Possible hccapx converter locations
possible_hccapx_converter_known_locations=(
										"/usr/lib/hashcat-utils/${hccapx_tool}.bin"
									)

#==============================================
# BIẾN JOHN THE RIPPER / JOHN THE RIPPER VARIABLES
#==============================================

# Tên file tạm JTR / JTR temporary filename
jtr_tmp_simple_name_file="jtrtmp"

# File POT tạm JTR / JTR POT temporary file
jtr_pot_tmp="${jtr_tmp_simple_name_file}.pot"

# File output JTR / JTR output file
jtr_output_file="${jtr_tmp_simple_name_file}.out"

#==============================================
# BIẾN WEP / WEP VARIABLES
#==============================================

# Tên dữ liệu WEP / WEP data name
wep_data="wepdata"

# Thư mục WEP / WEP directory
wepdir="wep/"

# File tấn công WEP / WEP attack script
wep_attack_file="ag.wepattack.sh"

# Script xử lý key WEP / WEP key handler script
wep_key_handler="ag.wep_key_handler.sh"

# File tiến trình WEP / WEP processes file
wep_processes_file="wep_processes"

# File log besside / Besside log file
wep_besside_log="ag.besside.log"

#==============================================
# BIẾN WPA3 / WPA3 VARIABLES
#==============================================

# Phiên bản aircrack hỗ trợ WPA3 / Aircrack version supporting WPA3
aircrack_wpa3_version="1.7"

# Mảng hàm menu plugin WPA3 / WPA3 plugin menu option functions
wpa3_plugin_menu_option_functions=()

# Mảng chuỗi ngôn ngữ menu plugin WPA3 / WPA3 plugin menu option language strings
wpa3_plugin_menu_option_language_strings=()

#==============================================
# BIẾN DOCKER / DOCKER VARIABLES
#==============================================

# Distribution Docker cơ sở / Base Docker distribution
docker_based_distro="Kali"

# Thư mục IO Docker / Docker IO directory
docker_io_dir="/io/"

#==============================================
# BIẾN WPS / WPS VARIABLES
#==============================================

# Phiên bản tối thiểu reaver/pixiewps / Minimum reaver/pixiewps version
minimum_reaver_pixiewps_version="1.5.2"

# Phiên bản tối thiểu reaver nullpin / Minimum reaver nullpin version
minimum_reaver_nullpin_version="1.6.1"

# Phiên bản tối thiểu bully/pixiewps / Minimum bully/pixiewps version
minimum_bully_pixiewps_version="1.1"

# Phiên bản tối thiểu bully verbosity4 / Minimum bully verbosity4 version
minimum_bully_verbosity4_version="1.1"

# Phiên bản tối thiểu wash JSON / Minimum wash JSON version
minimum_wash_json_version="1.6.2"

# File database PIN đã biết / Known PIN database file
known_pins_dbfile="known_pins.db"

# File checksum PIN database / PIN database checksum file
pins_dbfile_checksum="pindb_checksum.txt"

# PIN generic mặc định WPS / WPS default generic PIN
wps_default_generic_pin="12345670"

# File script tấn công WPS / WPS attack script file
wps_attack_script_file="ag.wpsattack.sh"

# File output WPS / WPS output file
wps_out_file="ag.wpsout.txt"

# Thời gian chờ mỗi PIN (giây) / Timeout per PIN (seconds)
timeout_secs_per_pin="30"

# Thời gian chờ mỗi PixieDust (giây) / Timeout per PixieDust (seconds)
timeout_secs_per_pixiedust="30"

#==============================================
# BIẾN KHO VÀ LIÊN HỆ / REPOSITORY AND CONTACT VARIABLES
#==============================================

# Tên host kho / Repository hostname
repository_hostname="github.com"

# Người dùng GitHub / GitHub user
github_user="v1s1t0r1sh3r3"

# Tên kho GitHub / GitHub repository name
github_repository="airgeddon"

# Nhánh / Branch
branch="master"

# Tên file script / Script filename
script_filename="airgeddon.sh"

# URL GitHub / GitHub URL
urlgithub="https://${repository_hostname}/${github_user}/${github_repository}"

# URL tải script trực tiếp / Direct script download URL
urlscript_directlink="https://raw.githubusercontent.com/${github_user}/${github_repository}/${branch}/${script_filename}"

# URL tải database PIN / PIN database download URL
urlscript_pins_dbfile="https://raw.githubusercontent.com/${github_user}/${github_repository}/${branch}/${known_pins_dbfile}"

# URL tải checksum PIN database / PIN database checksum download URL
urlscript_pins_dbfile_checksum="https://raw.githubusercontent.com/${github_user}/${github_repository}/${branch}/${pins_dbfile_checksum}"

# URL tải file ngôn ngữ / Language strings download URL
...
# Repo plugin WPA3 online attack / WPA3 online attack plugin repo
wpa3_online_attack_plugin_repo="https://${repository_hostname}/OscarAkaElvis/airgeddon-plugins"

# Repo plugin Dragon Drain WPA3 / Dragon Drain WPA3 plugin repo
wpa3_dragon_drain_plugin_repo="https://${repository_hostname}/Janek79ax/dragon-drain-wpa3-airgeddon-plugin"

# Repo plugin Cookie Guzzler WPA3 / Cookie Guzzler WPA3 plugin repo
wpa3_cookie_guzzler_plugin_repo="https://${repository_hostname}/OscarAkaElvis/airgeddon-plugins"

#==============================================
# BIẾN DHCPD, HOSTAPD, HOSTAPD-WPE, HOSTAPD-MANA VÀ EVIL TWIN
# DHCPD, HOSTAPD, HOSTAPD-WPE, HOSTAPD-MANA AND MISC EVIL TWIN VARIABLES
#==============================================

# IP loopback / Loopback IP
loopback_ip="127.0.0.1"

# IPv6 loopback / Loopback IPv6
loopback_ipv6="::1/128"

# Giao diện loopback / Loopback interface
loopback_interface="lo"

# File tạm iptables/nftables / iptables/nftables temporary file
routing_tmp_file="ag.iptables_nftables"

# File cấu hình DHCPD / DHCPD configuration file
dhcpd_file="ag.dhcpd.conf"

# File PID DHCPD / DHCPD PID file
dhcpd_pid_file="dhcpd.pid"

# File cấu hình dnsmasq / dnsmasq configuration file
dnsmasq_file="ag.dnsmasq.conf"

# DNS internet 1 / Internet DNS 1
internet_dns1="8.8.8.8"

# DNS internet 2 / Internet DNS 2
internet_dns2="8.8.4.4"

# DNS internet 3 / Internet DNS 3
internet_dns3="139.130.4.5"

# Port proxy bettercap / Bettercap proxy port
bettercap_proxy_port="8080"

# Port DNS bettercap / Bettercap DNS port
...
# Phiên bản tối thiểu bettercap cho advanced options / Minimum bettercap version for advanced options
minimum_bettercap_advanced_options="1.5.9"

# Phiên bản tối thiểu bettercap fix BeEF iptables / Minimum bettercap version for BeEF iptables fix
minimum_bettercap_fixed_beef_iptables_issue="1.6.2"

# Phiên bản bettercap2 / bettercap2 version
bettercap2_version="2.0"

# Phiên bản bettercap2 SSLstrip working / bettercap2 SSLstrip working version
bettercap2_sslstrip_working_version="2.28"

# File log ettercap / ettercap log file
ettercap_file="ag.ettercap.log"

# File log bettercap / bettercap log file
bettercap_file="ag.bettercap.log"

# File cấu hình bettercap / bettercap config file
bettercap_config_file="ag.bettercap.cap"

# File hook bettercap / bettercap hook file
bettercap_hook_file="ag.bettercap.js"

# Port BeEF / BeEF port
beef_port="3000"

# URL bảng điều khiển BeEF / BeEF control panel URL
beef_control_panel_url="http://${loopback_ip}:${beef_port}/ui/panel"

# File hook JavaScript / JavaScript hook file
jshookfile="hook.js"

# File cấu hình BeEF / BeEF config file
beef_file="ag.beef.conf"

# Mật khẩu BeEF / BeEF password
beef_pass="airgeddon"

# Database BeEF / BeEF database
beef_db="beef.db"

# File cấu hình mặc định BeEF / BeEF default config file
beef_default_cfg_file="config.yaml"

# Phiên bản BeEF cần brackets / BeEF version needing brackets
beef_needed_brackets_version="0.4.7.2"

# URL cài đặt BeEF / BeEF installation URL
beef_installation_url="https://${repository_hostname}/beefproject/beef/wiki/Installation"

# File cấu hình hostapd / hostapd config file
hostapd_file="ag.hostapd.conf"

# Phiên bản hostapd hỗ trợ WiFi 7 / hostapd version supporting WiFi 7
hostapd_wifi7_version="2.12"

# Phiên bản hostapd-wpe hỗ trợ WiFi 7 / hostapd-wpe version supporting WiFi 7
hostapd_wpe_wifi7_version="2.12"

# File cấu hình hostapd-wpe / hostapd-wpe config file
hostapd_wpe_file="ag.hostapd_wpe.conf"

# File log hostapd-wpe / hostapd-wpe log file
hostapd_wpe_log="ag.hostapd_wpe.log"

# File log mặc định hostapd-wpe / hostapd-wpe default log file
hostapd_wpe_default_log="hostapd-wpe.log"

# File cấu hình hostapd-mana / hostapd-mana config file
hostapd_mana_file="ag.hostapd_mana.conf"

# File log hostapd-mana / hostapd-mana log file
hostapd_mana_log="ag.hostapd_mana.log"

# File output hostapd-mana / hostapd-mana output file
hostapd_mana_out="ag.hostapd_mana.hccapx"

# File điều khiển ettercap / ettercap control file
control_et_file="ag.et_control.sh"

# File điều khiển enterprise / enterprise control file
control_enterprise_file="ag.enterprise_control.sh"

# Thư mục enterprise / Enterprise directory
enterprisedir="enterprise/"

# Thư mục chứng chỉ / Certificates directory
certsdir="certs/"

# Mật khẩu chứng chỉ / Certificate password
certspass="airgeddon"

# Đường dẫn chứng chỉ mặc định / Default certificates path
default_certs_path="/etc/hostapd-wpe/certs/"

# Mật khẩu chứng chỉ mặc định / Default certificates password
default_certs_pass="whatever"

# Mật khẩu mana / Mana password
mana_pass="airgeddon"

# File capture mana / Mana capture file
mana_cap_file="ag.mana.cap"

# File tạm mana / Mana temporary file
mana_tmp_file="ag.mana.txt"

# File cấu hình lighttpd / lighttpd config file
webserver_file="ag.lighttpd.conf"

# File log lighttpd / lighttpd log file
webserver_log="ag.lighttpd.log"

# Thư mục web / Web directory
webdir="www/"

# File index / Index file
indexfile="index.htm"

# File kiểm tra / Check file
checkfile="check.htm"

# File CSS portal / Portal CSS file
cssfile="portal.css"

# File JavaScript portal / Portal JavaScript file
jsfile="portal.js"

# File pixel theo dõi / Tracking pixel file
pixelfile="pixel.png"

# file attempts / Attempts file
attemptsfile="ag.et_attempts.txt"

# File mật khẩu hiện tại / Current password file
currentpassfile="ag.et_currentpass.txt"

# File thành công Evil Twin / Evil Twin success file
et_successfile="ag.et_success.txt"

# File thành công enterprise / Enterprise success file
enterprise_successfile="ag.enterprise_success.txt"

# File tiến trình Evil Twin / Evil Twin processes file
et_processesfile="ag.et_processes.txt"

# File POT tạm asleap / asleap POT temporary file
asleap_pot_tmp="ag.asleap_tmp.txt"

# File kênh / Channel file
channelfile="ag.et_channel.txt"

# File dải tần / Band file
bandfile="ag.et_band.txt"

# Portal PHP như CGI / PHP portal as CGI
customportals_php_as_cgi=1

# Các vị trí có thể tìm file lease DHCP / Possible DHCP lease file locations
...
# Các vị trí có thể tìm BeEF / Possible BeEF locations
